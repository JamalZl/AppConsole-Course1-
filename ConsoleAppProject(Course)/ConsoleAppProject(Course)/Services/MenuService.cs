...
namespace ConsoleAppProject_Course_.Services
{
    static class MenuService
    {
        ...
        public static void CreateStudenMenu()
        {
            ...
            {
                case 1:
                    Console.WriteLine(courseService.CreateStudent(studfullname, EducationType.Guarranted));
                    break;
                case 2:
                    Console.WriteLine(courseService.CreateStudent(studfullname, EducationType.non_Guarranted));
                    break;
                default:
                    break;
            }
